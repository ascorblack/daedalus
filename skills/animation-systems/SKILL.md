...
description: Product-grade web motion in the manner of Stripe, Linear, Apple, Vercel: principles, easing and duration defaults, choreography, scroll and hover interactions, performance, reduced-motion accessibility.
---
