% Shared TikZ scaffold for method and architecture diagrams.
% Adapted from alphaXiv OpenResearch (MIT, (c) 2026 alphaXiv); the licence is in
% skills/THIRD-PARTY.md of the host repository.
%
