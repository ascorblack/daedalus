# bright-green-tech-system-webgl — original design system
...
A complete page in this system: `systems/bright-green-tech-system-webgl.demo.html` (read it for the real CSS and markup).
