# high-contrast-skeuomorphic-clean — original design system
...
A complete page in this system: `systems/high-contrast-skeuomorphic-clean.demo.html` (read it for the real CSS and markup).
