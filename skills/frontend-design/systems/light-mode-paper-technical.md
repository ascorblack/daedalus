# light-mode-paper-technical — original design system
...
A complete page in this system: `systems/light-mode-paper-technical.demo.html` (read it for the real CSS and markup).
