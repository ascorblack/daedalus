# funky-purple-container-tech — original design system
...
A complete page in this system: `systems/funky-purple-container-tech.demo.html` (read it for the real CSS and markup).
