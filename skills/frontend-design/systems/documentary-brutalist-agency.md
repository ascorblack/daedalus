# documentary-brutalist-agency — original design system
...
A complete page in this system: `systems/documentary-brutalist-agency.demo.html` (read it for the real CSS and markup).
