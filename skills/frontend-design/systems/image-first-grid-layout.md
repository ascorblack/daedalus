# image-first-grid-layout — original design system
...
A complete page in this system: `systems/image-first-grid-layout.demo.html` (read it for the real CSS and markup).
