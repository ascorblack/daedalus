# technical-wireframe-info-layout — original design system
...
A complete page in this system: `systems/technical-wireframe-info-layout.demo.html` (read it for the real CSS and markup).
