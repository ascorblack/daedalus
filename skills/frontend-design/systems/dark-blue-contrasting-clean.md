# dark-blue-contrasting-clean — original design system
...
A complete page in this system: `systems/dark-blue-contrasting-clean.demo.html` (read it for the real CSS and markup).
