# agency-grid-layout-minimal — original design system
...
A complete page in this system: `systems/agency-grid-layout-minimal.demo.html` (read it for the real CSS and markup).
