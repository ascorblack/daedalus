# mesh-gradient-dark-blue-clean — original design system
...
A complete page in this system: `systems/mesh-gradient-dark-blue-clean.demo.html` (read it for the real CSS and markup).
