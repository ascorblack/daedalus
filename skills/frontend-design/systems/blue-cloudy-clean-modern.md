# blue-cloudy-clean-modern — original design system
...
A complete page in this system: `systems/blue-cloudy-clean-modern.demo.html` (read it for the real CSS and markup).
