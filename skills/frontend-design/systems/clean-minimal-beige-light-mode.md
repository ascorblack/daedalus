# clean-minimal-beige-light-mode — original design system
...
A complete page in this system: `systems/clean-minimal-beige-light-mode.demo.html` (read it for the real CSS and markup).
