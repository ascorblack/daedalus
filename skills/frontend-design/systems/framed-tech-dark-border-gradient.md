# framed-tech-dark-border-gradient — original design system
...
A complete page in this system: `systems/framed-tech-dark-border-gradient.demo.html` (read it for the real CSS and markup).
