# tech-green-dark-mode-modern — original design system
...
A complete page in this system: `systems/tech-green-dark-mode-modern.demo.html` (read it for the real CSS and markup).
