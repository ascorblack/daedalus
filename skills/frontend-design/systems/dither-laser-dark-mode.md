# dither-laser-dark-mode — original design system
...
A complete page in this system: `systems/dither-laser-dark-mode.demo.html` (read it for the real CSS and markup).
