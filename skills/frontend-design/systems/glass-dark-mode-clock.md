# glass-dark-mode-clock — original design system
...
A complete page in this system: `systems/glass-dark-mode-clock.demo.html` (read it for the real CSS and markup).
