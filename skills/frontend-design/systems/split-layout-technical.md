# split-layout-technical — original design system
...
A complete page in this system: `systems/split-layout-technical.demo.html` (read it for the real CSS and markup).
