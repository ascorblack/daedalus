# operational-enterprise-ai — original design system
...
A complete page in this system: `systems/operational-enterprise-ai.demo.html` (read it for the real CSS and markup).
