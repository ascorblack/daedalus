# orange-clean-paper-saas — original design system
...
A complete page in this system: `systems/orange-clean-paper-saas.demo.html` (read it for the real CSS and markup).
