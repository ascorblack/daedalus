...
description: Evidence-backed audit of websites, apps, screenshots, mockups or design code for AI-design clichés, generic defaults and UI defects, with a removal-first cleanup plan instead of a speculative redesign.
---
