...
description: Domain-specific design decisions for frontend UI (dashboards, admin panels, landing and marketing pages, web apps): typography, colour world, layout, CSS tokens, depth and spacing; routes to app.md or marketing.md by context.
---
