...
description: Execution-and-verification loop for any substantial task: fan out to subagents or independent reviewers, benchmark against references, harsh critic, blind comparison of candidates, continue until explicit quality gates pass, without losing the original request.
---
