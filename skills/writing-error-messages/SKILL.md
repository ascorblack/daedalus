...
description: Write or review user-facing error, validation, empty-state, auth, failure, retry, CLI and API messages: specific, actionable, non-blaming, accessible, without leaking sensitive details.
---
