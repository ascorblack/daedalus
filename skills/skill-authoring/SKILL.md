...
description: Author, refine or troubleshoot an agent skill: scaffold SKILL.md and front matter, write the trigger description, structure the body with progressive disclosure, validate, and debug a skill that does not trigger or is ignored.
---
# Skill Authoring
...
The upstream repository vendors the authoring approaches this skill synthesises under `sources/` (not imported here, see README.md for the inventory).
