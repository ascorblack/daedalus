...
description: React composition patterns that scale (compound components, render props, context providers, React 19 APIs): use when refactoring boolean-prop-heavy components or designing reusable component APIs.
---
