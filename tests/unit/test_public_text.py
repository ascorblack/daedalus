...
def test_public_text_strips_private_lines_addresses_and_secrets() -> None:
    raw = (
        "Fix the thing.\n\nSession: abc123\nRun: r9\nVerified on http://192.0.2.10:9000 from /home/someone/x and /srv/state/config.toml.\n"
    ...
    assert "192.0.2.10" not in out and "/home/someone" not in out and "/srv/state" not in out
