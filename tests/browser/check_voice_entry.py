...
def open_list(browser, viewport: dict, route: str):  # type: ignore[no-untyped-def]
...
def check_the_row(browser, check, where: str, scope: str, viewport: dict, route: str) -> None:  # type: ignore[no-untyped-def]
    context, page = open_list(browser, viewport, route)
