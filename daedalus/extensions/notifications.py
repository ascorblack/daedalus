...
class NotificationService:
    ...
    async def _facts(self, session_id: str | None, project_id: str | None, staff_id: str | None, source: str) -> tuple[TelegramFacts, ProjectNotifyPolicy, str | None]:
        ...
        facts = TelegramFacts(
            ...
            # A subagent never speaks in Telegram, whatever its leader does: its work reaches the
            # operator through the leader, so the router treats it as detached, like the front does.
