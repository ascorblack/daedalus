...
WORDS = """
    ...
    янв+арь февр+аль апр+ель +август сент+ябрь окт+ябрь но+ябрь дек+абрь
    ...
    прог+он прог+она з+апуск з+апуска пров+ерка пров+ерки кон+ец
    ф+айлы п+апка п+апке стран+ица стран+ицы сс+ылка сс+ылки
    ...
    п+адали уп+ало раб+отало сраб+отало
    ...
    нач+ать зак+ончил зак+ончить гот+ово гот+ов
    п+ару чет+ыре в+осемь д+евять д+есять
    п+ервый втор+ой тр+етий посл+едний сл+едующий
    хорош+о пл+охо б+ыстро м+едленно пр+осто сл+ожно легк+о т+очно в+ерно
    +именно кон+ечно нав+ерное возм+ожно об+ычно почт+и совс+ем т+олько
    ...
    б+ыстрый м+едленный компь+ютер прогр+амма прогр+аммы разд+ел
    """
