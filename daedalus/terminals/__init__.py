...
the machine-wide cap (``service``), estimates what more terminals would cost (``load``), and lets a
browser attach through a one-use ticket and a WebSocket relay (``gateway``). The HTTP routes live
in the API extension, the one module allowed the web framework; everything they do is here.
"""
