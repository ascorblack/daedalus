...
DEFAULT_TOOLS_OFF = ["SendFile", "AttachMedia", "ImageView", "Remember", "Recall", "SpawnAgent", "ScheduleCreate", "ScheduleDelete", "ScheduleList", "SelfWorkspace", "SelfPropose", "SelfApply", "SelfRebuild", "SelfRollback", "AskUser", "AskPeer", "PeerList", "BoardAdd", "BoardUpdate", "BoardList", "BoardGet", "IntentCreate", "IntentList", "IntentDelete", "LoopNext", "LoopStop", "LoopPause", "LoopResume", "LoopStatus", "ServiceStart", "ServiceStop", "ServiceList", "ServiceLogs", "TerminalRead", "McpList", "McpEnable", "McpDisable", "McpOAuthStatus", "McpOAuthBegin", "McpOAuthFinish", "McpOAuthDisconnect", "StaySilent", "LearningReport"]
"""What a benchmark session never needs: every self-development tool (on a local installation ``SelfApply`` would change the very install being benchmarked), everything that talks to the operator, the board, or the host's own lifecycle, the vision model (a benchmark config has none), and the long-term memory (a fact carried from one task to the next is contamination)."""
