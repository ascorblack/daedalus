...
import { agentFolders, folderBase, folderName, needsMount, offersFolderChoice, pathProblem, primaryFolder, projectPath, projectReachable, reachIsProblem, reachKey } from "./folders";
